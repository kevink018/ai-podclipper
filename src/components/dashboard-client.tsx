...
import { ClipDisplay } from "./clips-display";
...
export function DashboardClient({
  ...
  const handleUpload =  async () => {
    ...
    try {
      ...
      if (!uploadResponse.ok) throw new Error(`Upload filed with status: ${uploadResponse.status}`);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Upload your podcast and get AI-generted clips instantly
          </p>
        </div>
      ...
      <Tabs defaultValue="upload">
        ...
        <TabsContent value="upload">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload your audio or video file to generate clps
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Dropzone
                  ...
                  <>
                    <div className="flex flex-col items-center justify-center space-y-4 rounded-lg p-10 text-center">
                      ...
                      <p className="text-muted-foreground text-sm">
                        or click to brose (MP4 up to 500M)
                      </p>
                      <Button
              ...
              { uploadedFiles.length > 0 && (
                <div className="pt-6">
                  ...
                  <Button variant="outline" size="sm" onClick={handleRefresh} disabled={refreshing}>
                    {refreshing && (<Loader2 className="mr-2 h-4 w-4 animate-spin" />)} Refresh </Button>
                  </div>
        ...
        <TabsContent value ="my-clips">
          <Card>
            ...
            <CardContent> <ClipDisplay clips={clips} /></CardContent>
          </Card>
